<?php
/**
 * Plugin Name: Display Acf oEmbed 
 * Plugin URI: https://divi.tech
 * Description: Allows the usage of ACF oEmebed filed type to be display inside Divi's Code Module
 * Version: 1.0.0
...
/*
 * Usage [dt-acf-video acf_id='my-video']
 * - my-video - is the ACF oEmbed field's ID;
 */

add_shortcode('dt-acf-video', 'dt_show_video');
